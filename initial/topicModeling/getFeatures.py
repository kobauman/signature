...
def getFeatures(logger, aspect, reviewsSet, busImportantFeatures, userImportantFeatures,
    ...
    for review in reviewsSet:
        reviewFeatures = review['features']['1']
        if aspect in reviewFeatures:
            weight = reviewFeatures[aspect]
        else:
            weight = 0
        ...
        bus_basic_features = getBasicFeatures(aspect, busID, busImportantFeatures, is_train)
        user_basic_features = getBasicFeatures(aspect, userID, userImportantFeatures, is_train)
