...
def learnTopicModel(infileName, dictFile, modelFile, descriptionFile, topic_num = 10):
    ...
    lda_model = models.ldamodel.LdaModel(corpus=corpus_int, id2word=dictionary, num_topics=topic_num, update_every=1, chunksize=10000, passes=20)
...
def learnTopics(path, topic_num = 10):
    ...
    learnTopicModel(infileName, dictFile, modelFile, descriptionFile, topic_num = topic_num)
