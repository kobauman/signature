...
def applyAggregationModel(testReviews, featureAvgSent, model, busImportantFeatures, userImportantFeatures):
    ...
    for r, review in enumerate(testReviews):
        ...
        review['rating_prediction']['aggregationRR'] = aggregationRR
        review['rating_prediction']['aggregationPR'] = aggregationPR
        review['rating_prediction']['aggregationRP'] = aggregationRP
        review['rating_prediction']['aggregationPP'] = aggregationPP
        review['rating_prediction']['aggregationBUS'] = aggregationBUS
